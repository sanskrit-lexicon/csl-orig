...
def parse_k2s(rec):
 ...
 if rec.k1 != rec.k1s[0]:
  print('parse k2s error for first element:',rec.line)
  print('parent k1="%s", constructed first k1= "%s"' % (rec.k1,rec.k1s[0]))
