...
redo.sh does all of the following, starting with ../pwkvn.txt
========================================================================

Recreate ../pwkvn_hwextra.txt

python hwextra.py ../pwkvn.txt ../pwkvn_hwextra.txt

========================================================================
#Recreate pwkvn_hk.txt
