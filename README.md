...
— currently **45 dictionary subfolders** under
[v02/](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02), from `abch`
to `snp` and beyond.
...
discipline is the load-bearing safety mechanism, not a formality. The full
procedure is documented in the canonical
...
> Note: this read-only-for-direct-pushes rule governs **dictionary text
> corrections**. Ordinary repository-maintenance content (this README, CI
> config, and the like) is delivered by normal pull request.

---

## Correction workflow (summary)

The full 8-stage sequence — snapshot, apply via `updateByLine.py` or an
equivalent controlled edit, regenerate + XML-validate, write the
...
- `v02/<dict>/<dict>.txt` files are canonical and may only change through the
  ...
  batched PR).
- Before applying any correction issue, check the sibling
  [csl-corrections](https://github.com/sanskrit-lexicon/csl-corrections) CFR
...
45 dictionary directories currently exist under
[v02/](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02), including
[abch](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/abch),
[ap90](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/ap90),
[ben](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/ben),
[fri](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/fri),
[gra](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/gra),
[ieg](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/ieg),
[mw](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/mw),
[pw](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/pw),
[pwg](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/pwg),
[pwkvn](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/pwkvn),
[shs](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/shs), and
[skd](https://github.com/sanskrit-lexicon/csl-orig/tree/main/v02/skd) — this
repo carries the full CDSL corpus, not only the handful of dictionaries the
parent org actively maintains tooling for.

---

## Status

Issues are tracked against the
[Cologne issue taxonomy](https://github.com/sanskrit-lexicon/csl-observatory/blob/main/runbook/cologne-tooling-runbook.md).
As of 11-07-2026: **30 open, 2777 closed**. The overwhelming bulk of closed work
sits under the **Digitization Quality** milestone (2709 closed); **Structured
Data** (43 closed) and **Major Enhancements** (14 closed) hold the rest, with a
small tail of legacy date-labelled milestones. Recent commit activity is
dominated by per-dictionary correction commits flowing through the documented
workflow, plus front-matter and paper-related work on specific dictionaries.
...
- **Validation**: `csl-pywork` (`generate_dict.sh`, `xmlchk_xampp.sh`,
  `make_xml.py` for the Windows-without-XAMPP fallback)
